                                ...
                                <div className='review-section '>
                                    ...
                                    <form onSubmit={(e) => e.preventDefault()} className='px-[18px] py-[30px] md:px-[30px] md:py-[34px] bg-[#F4F4F4] rounded-[3px]'>
                                        ...
                                        <p className='flex text-lg text-[#706F6C] mb-[5px]'>
                                            {new Array(countStar).fill(0).map((_, index) => <AiFillStar className='cursor-pointer' onClick={() => setCountStar(index + 1)}></AiFillStar>)}
                                            {new Array(5 - countStar).fill(0).map((_, index) => <AiOutlineStar className='cursor-pointer' onClick={() => setCountStar(pre => pre + (index + 1))}></AiOutlineStar>)}
                                        </p>
                                        ...
                                        <label htmlFor="name" className='text-[12.5px] md:text-[14px] font-bold mb-[11px] cursor-pointer '>Name *</label>
