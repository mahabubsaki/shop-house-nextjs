                    ...
                    <div className='w-[100%] lg:w-[25%]'>
                        <div className='sticky top-24'>
                            ...
                            <div className='flex flex-col'>
                                ...
                                {['Orders', 'Wishlist', 'Addresses', 'Refunds', 'Points and Savings', 'Coupouns', 'Reviews', 'Account Details', 'Manage Products', 'Manage Categories', 'Manage Orders', 'Manage Users', 'Manage Blogs'].slice(0, 8).map(item =>
